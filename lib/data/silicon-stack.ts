...
export const COMPANIES: Record<string, Company> = {
  nvidia: {
    ...
    desc: l(
      'Designs the GPUs and rack-scale systems at the heart of AI data centers. Fabless — every leading chip is manufactured and packaged by TSMC in Taiwan.',
      '設計 AI 資料中心核心的 GPU 與整櫃系統。無晶圓廠 — 每一顆旗艦晶片都由台灣的台積電製造與封裝。',
    ),
    links: [
      { to: 'tsmc', label: l('sole foundry for its GPUs', 'GPU 唯一代工廠') },
      { to: 'skhynix', label: l('primary HBM supplier', '主要 HBM 供應商') },
      { to: 'foxconn', label: l('builds its rack systems', '組裝整櫃系統') },
      { to: 'quanta', label: l('builds its servers', '製造伺服器') },
    ],
  },
  ...
  tsmc: {
    ...
    desc: l(
      'The world’s dominant advanced foundry. Nearly every leading AI chip is manufactured on its EUV-based nodes in Hsinchu, Taichung and Tainan.',
      '全球最強的先進製程代工廠。幾乎所有旗艦 AI 晶片都在新竹、台中、台南的 EUV 產線上誕生。',
    ),
    links: [
      { to: 'nvidia', label: l('chief AI customer', '最大 AI 客戶') },
      { to: 'asml', label: l('buys its EUV machines', '採購其 EUV 機台') },
      { to: 'shinetsu', label: l('wafer & resist supplier', '晶圓與光阻供應商') },
      { to: 'globalwafers', label: l('wafer supplier', '晶圓供應商') },
      { to: 'ase', label: l('packaging partner', '封裝夥伴') },
    ],
  },

  foxconn: {
    short: 'Foxconn',
    name: 'Hon Hai 鴻海 (Foxconn)',
    ticker: '2317.TW',
    exch: 'TWSE',
    country: l('Taiwan', '台灣'),
    priceText: 'NT$182.0',
    ...
    desc: l(
      'The world’s largest electronics manufacturer. Assembles full GB-series AI racks for NVIDIA and the hyperscalers.',
      '全球最大電子製造商。為 NVIDIA 與各大雲端巨頭組裝完整的 GB 系列 AI 機櫃。',
    ),
    links: [
      { to: 'nvidia', label: l('rack systems partner', '機櫃系統夥伴') },
      { to: 'delta', label: l('power supplier', '電源供應商') },
    ],
  },
  ...
  quanta: {
    ...
    desc: l(
      'Taiwanese ODM designing and building AI servers for the major US cloud providers.',
      '為美國主要雲端服務商設計並製造 AI 伺服器的台灣 ODM 大廠。',
    ),
    links: [
      { to: 'nvidia', label: l('server platform partner', '伺服器平台夥伴') },
      { to: 'avc', label: l('thermal supplier', '散熱供應商') },
    ],
  },
  ...
  smci: {
    ...
    desc: l(
      'Builds liquid-cooled, rack-scale AI systems — with most motherboards and subassemblies made in Taiwan.',
  ...
  delta: {
    ...
    desc: l(
      'Powers the AI buildout: server PSUs, rack busbars, and liquid-cooling systems. A quiet giant of the Taiwan exchange.',
      '撐起 AI 建設的電力：伺服器電源、機櫃匯流排與液冷系統。台股裡低調的巨人。',
    ),
    links: [
      { to: 'foxconn', label: l('supplies rack power', '供應機櫃電源') },
      { to: 'quanta', label: l('supplies server PSUs', '供應伺服器電源') },
    ],
  },
  ...
  vertiv: {
    ...
    desc: l(
      'Coolant distribution units, in-row cooling and power management for AI data centers.',
  ...
  avc: {
    ...
    desc: l(
      '3D vapor chambers, heatsinks and liquid cold plates that keep 1,000W GPUs from melting.',
      '3D 均熱板、散熱器與液冷冷板，讓一千瓦的 GPU 不至於熔化。',
    ),
    links: [
      { to: 'quanta', label: l('supplies cooling', '供應散熱') },
      { to: 'foxconn', label: l('supplies cooling', '供應散熱') },
    ],
  },

  gce: {
    short: 'GCE',
    name: 'Gold Circuit Electronics 金像電',
    ticker: '2368.TW',
    exch: 'TWSE',
    country: l('Taiwan', '台灣'),
    priceText: 'NT$295.0',
    ...
    desc: l(
      'High-layer-count printed circuit boards for GPU baseboards and switch trays.',
  ...
  aspeed: {
    ...
    desc: l(
      'A 100-person Taiwanese fabless firm whose baseboard-management chips sit inside most of the world’s servers.',
  ...
  broadcom: {
    ...
    desc: l(
      'Switch and NIC silicon that stitches thousands of GPUs into one training cluster.',
  ...
  skhynix: {
    ...
    desc: l(
      'Leads high-bandwidth memory — the stacked DRAM that feeds data to the GPU die at terabytes per second.',
      '高頻寬記憶體霸主 — 堆疊式 DRAM 以每秒 TB 級速度餵資料給 GPU。',
    ),
    links: [
      { to: 'nvidia', label: l('primary HBM customer', '最大 HBM 客戶') },
      { to: 'tsmc', label: l('HBM base-die partner', 'HBM 基底晶片夥伴') },
    ],
  },
  ...
  micron: {
    ...
    desc: l(
      'The US challenger in high-bandwidth memory, ramping HBM4 for next-gen accelerators.',
  ...
  samsung: {
    ...
    desc: l(
      'Memory giant and the only meaningful foundry rival to TSMC at the leading edge.',
  ...
  unimicron: {
    ...
    desc: l(
      'The resin substrate that fans the die’s microscopic wiring out to the motherboard. Quietly indispensable.',
      '把裸晶顯微等級的線路「扇出」到主機板的樹脂載板。低調卻不可或缺。',
    ),
    links: [
      { to: 'tsmc', label: l('substrate supplier', '載板供應商') },
  ...
  ibiden: {
    ...
    desc: l(
      'Japanese maker of the highest-end IC package substrates for AI processors.',
  ...
  ase: {
    ...
    desc: l(
      'Packages and final-tests chips for the whole industry, absorbing overflow from TSMC’s advanced packaging lines.',
  ...
  asml: {
    ...
    desc: l(
      'The only company on Earth that builds EUV machines — €200M+ each, 100,000+ parts, shipped in 40 freight containers. No EUV, no advanced AI chips.',
      '地球上唯一造得出 EUV 機台的公司 — 每台逾兩億歐元、超過十萬個零件、要用四十個貨櫃運送。沒有 EUV，就沒有先進 AI 晶片。',
    ),
    links: [
      { to: 'zeiss', label: l('sole optics supplier', '唯一光學供應商') },
      { to: 'tsmc', label: l('largest EUV customer', '最大 EUV 客戶') },
      { to: 'samsung', label: l('EUV customer', 'EUV 客戶') },
    ],
  },
  ...
  zeiss: {
    ...
    ticker: 'Private',
    exch: '—',
    country: l('Germany', '德國'),
    private: true,
    note: l('Privately held — ASML owns a 24.9% stake', '未上市 — ASML 持股 24.9%'),
    priceText: '—',
    chg: 0,
    mcapText: '—',
    ...
    desc: l(
      'Grinds EUV mirrors so precise that, scaled to the size of Germany, the largest bump would be 0.1 mm. Every ASML machine depends on them.',
  ...
  shinetsu: {
    ...
    desc: l(
      'The light-sensitive chemicals that record EUV patterns, and the ultra-pure silicon wafers they’re printed on.',
  ...
  globalwafers: {
    ...
    desc: l(
      'Taiwanese maker of the 300mm mirror-polished silicon discs every chip begins life on.',
  ...
  tel: {
    ...
    desc: l(
      'Its coater-developer tools apply and develop photoresist — bolted directly onto every ASML EUV machine.',
      '塗佈顯影機負責上光阻與顯影 — 直接對接在每台 ASML EUV 機台上。',
    ),
    links: [
      { to: 'asml', label: l('inline tool partner', '線上設備夥伴') },
  ...
  lam: {
    ...
    desc: l(
      'Etch machines that carve the printed pattern into silicon, atom layer by atom layer.',
  ...
  amat: {
    ...
    desc: l(
      'Deposits the atom-thin films — metals, insulators — that build up a chip’s 60+ layers.',
  ...
  kla: {
    ...
    desc: l(
      'Finds nanometer-scale defects. At 4nm, a single dust particle is a boulder — KLA is the industry’s microscope.',
