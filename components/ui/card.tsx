...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-muted/50 flex items-center rounded-b-[var(--radius-lg)] border-t p-(--card-spacing)',
        className,
      )}
      {...props}
    />
